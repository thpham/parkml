          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="form-control">
              <label className="label">
                <span className="label-text">{t('dailyActivities.activityLevel.totalRestTime')}</span>
              </label>
              <input
      ...
      <div className="card bg-base-200">
        <div className="card-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="form-control">
              <label className="label">
                <span className="label-text">{t('dailyActivities.medicationCompliance.morning')}</span>
              </label>
              <select
              ...
              >
                ...
                <option value="taken_as_prescribed">{t('dailyActivities.medicationStatus.takenAsPrescribed')}</option>
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text">{t('dailyActivities.medicationCompliance.afternoon')}</span>
              </label>
              <select
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text">{t('dailyActivities.medicationCompliance.evening')}</span>
              </label>
              <select
          ...
          <div className="form-control mt-4">
            <label className="label">
              <span className="label-text">{t('dailyActivities.medicationCompliance.sideEffects')}</span>
            </label>
            <textarea
